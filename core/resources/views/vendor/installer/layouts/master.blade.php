...
<html>
    <head>
        ...
        <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif @lang('installer_messages.title')</title>
                    ...
                    @if(session()->has('errors'))
                        <div class="alert alert-danger" id="error_alert">
                            ...
                            <h4>
                                ...
                                @lang('installer_messages.forms.errorTitle')
                            </h4>
                            <ul>
